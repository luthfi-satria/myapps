    ...
    <div class="lg:flex lg:flex-col lg:items-stretch lg:opacity-100 lg:relative lg:mt-4 lg:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-x-hidden h-auto items-center flex-1 rounded hidden">
        ...
        <div class="relative">
            <ul class="sidebar lg:left-0 w-full overflow-y-auto">
                <li class='mt-1 flex items-center text-xl px-4 duration-300 cursor-pointer hover:bg-gray-200'>
                ...
                <?php
                    for($i=0; $i < 10; $i++){
                        echo '<li class="mt-1 flex items-center text-xl px-4 duration-300 cursor-pointer hover:bg-gray-200">';
                            echo '<a class="flex w-full py-2 items-center">';
                                echo 'Menu '.$i;
                            echo '</a>';
                        echo '</li>';
                    }
